...
const contents = [
  { icon: faHome, id: "home (footer)" },
  { icon: faUser, id: "user (footer)" },
  { icon: faCog, id: "cog (footer)" }
];

class PlainTabsStyle1Footer extends Component {
  state = {
    showDropdown: false
  };
...
export default PlainTabsStyle1Footer;
